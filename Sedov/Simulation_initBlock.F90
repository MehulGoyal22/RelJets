...
#include "Flash.h"
  ...
  real     ::  sumRho, sumP, sumVX, sumVY, sumVZ, posVec(3), dotProduct
  real     ::  vel, diagonal
...
!!$  if (.NOT. sim_useProfileFromFile .OR. sim_tinitial .LE. 0.0) then
  if (sim_tinitial .LE. 0.0) then
     ...
     !print*,"Entering the less than 0 condition"
...
!!$     else
        do i = 1, sim_nProfile
           ...
           vProf(i)   = 0. 
           print*,"Executed conditions near the line 150"
           !Increase this, see if it is a scaling parameter
     ...
     do k = blkLimitsGC(LOW,KAXIS), blkLimitsGC(HIGH,KAXIS)
        ...
        do j = blkLimitsGC(LOW, JAXIS), blkLimitsGC(HIGH, JAXIS)
           ...
           do i = blkLimitsGC(LOW,IAXIS), blkLimitsGC(HIGH, IAXIS)
              ...
              print*,"Executed conditions near the line 190"
#ifdef VLYA_VAR
           ...
           do kk = 0, (sim_nSubZones-1)*K3D
              ...
              do jj = 0, (sim_nSubZones-1)*K2D
                 ...
                 do ii = 0, (sim_nSubZones-1)
                    ...
                    dotProduct = posVec(1)*1 + posVec(2)*0 + posVec(3)*0
                    
                    if (dotProduct > 0.866) then
                    !print*,"Inside Cone"
                    vSub = vProf(jLo) + frac*(vProf(jHi)  - vProf(jLo)) + 1
...
!!$           quotinv = sim_inszd
           ...
           print*,"Executed conditions near the line 447"
           solnData(TEMP_VAR,i,j,k)=sim_smallT
#ifdef BDRY_VAR
           solnData(BDRY_VAR,i,j,k)=    -1.0
#endif
